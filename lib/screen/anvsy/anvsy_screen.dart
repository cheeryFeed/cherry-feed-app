...
class AnvsyScreen extends StatefulWidget {
  const AnvsyScreen({Key? key}) : super(key: key);

  // API URL
  static final String apiUrl = '${ApiHost.API_HOST_DEV}/api/v1/anvsy';

  @override
  State<AnvsyScreen> createState() => _AnvsyScreenState();
}

class _AnvsyScreenState extends State<AnvsyScreen> {
            ...
            NextButton(
              ...
              onPressed: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => AnvsyCreateScreen(
                              status: 1,
                            )));
              },
